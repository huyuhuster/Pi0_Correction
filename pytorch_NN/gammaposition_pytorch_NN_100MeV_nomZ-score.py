...
phase = '' # '_phase3'	
trainh5file = 'B2APi0selection_' + ID_train + '_crystal_addmcMatchWeight_modified_threshold' + str(threshold_train)  + '_Z-score.h5'
...
trainpklfile = Dir_pkl + 'NN_train_params_epoch499.pkl'
