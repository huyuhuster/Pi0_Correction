...
EPOCH = 2000
BATCH_SIZE = 8192*2  #8192  #32768   #8192 #32768  #16384
BATCH_SIZE_test = 100
LR = 0.001 #0.001
...
class Net(nn.Module):
    def __init__(self, n_feature,  n_output):
        ...
        self.hidden2 = torch.nn.Linear(640, 800)   # define hiden layer, liner out put
        self.hidden3 = torch.nn.Linear(800, 800)   # define hiden layer, liner out put
        self.hidden4 = torch.nn.Linear(800, 140)   # define hiden layer, liner out put
