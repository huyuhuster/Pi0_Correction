...
class Net(nn.Module):
    def __init__(self, n_feature,  n_output):
        ...
        self.hidden1 = torch.nn.Linear(n_feature, 1280)   # define hiden layer, liner out put
        # self.drop1   = torch.nn.Dropout(0.5)
        self.hidden2 = torch.nn.Linear(1280, 1280)   # define hiden layer, liner out put
        ...
        self.predict = torch.nn.Linear(1280, n_output)   # define output layer, liner out put
...
#	reader = pd.read_hdf(h5file, h5key_test, chunksize=1000000,  stop = 2000000)
	...
	for mydf_test in reader:
		...
		net.load_state_dict(torch.load(pklfile9, map_location='cpu'))
		net = net.double()
...
ID_train = '4055541376'  # '7151069798'   # '2927360606'   # '3975284924' 
ID_test  = '4055541376'  # '7245655874'   # '4908190819'   # '0010973571' # '3975284924' #'2927360606' # '7151069798' 
