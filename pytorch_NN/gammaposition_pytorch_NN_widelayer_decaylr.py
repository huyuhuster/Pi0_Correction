...
def train(h5file, h5key, pklfile, validationh5, trainedlossplot, train_target, train_lossh5):
        ...
        train_mode.write("Additional  :  "+ "For crystal 2626. And wider layer, learning reta decay." + '\n')
        train_mode.close()		
...
ID_test  = '7151069798'# '9242450162'  # '7245655874'   # '4908190819'   # '0010973571' # '3975284924' #'2927360606' # '7151069798' 
