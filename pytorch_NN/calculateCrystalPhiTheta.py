...
def definition3(R, Phi_c, Theta_c, Phi_d, Theta_d, L, W1, W2, Wc, S):
	...
	# lenghth
	at1 = fabs(Wc*sin(angle_t2)/sin(angle_t2+angle_t1))   # theta
	at2 = fabs(Wc*sin(angle_t2)/sin(angle_t2-angle_t1))
	ap1 = fabs(Wc*sin(angle_p2)/sin(angle_p2+angle_p1))   # phi
	ap2 = fabs(Wc*sin(angle_p2)/sin(angle_p2-angle_p1))
...
def definition4(R, Phi_c, Theta_c, Phi_d, Theta_d, L, W1, W2, Wc, S):
	...
	# lenghth
	at1 = fabs(Wc*sin(angle_t2)/sin(angle_t2-angle_t1)) 
	at2 = fabs(Wc*sin(angle_t2)/sin(angle_t2+angle_t1))   # theta
	ap1 = fabs(Wc*sin(angle_p2)/sin(angle_p2-angle_p1))
	ap2 = fabs(Wc*sin(angle_p2)/sin(angle_p2+angle_p1))   # phi
